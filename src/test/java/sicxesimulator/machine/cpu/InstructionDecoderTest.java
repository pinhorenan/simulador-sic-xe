...
public class InstructionDecoderTest {
    ...
    public void testFormat1() {
        ...
        assertEquals(1, inst.getFormat(), "Formato deve ser 1");
        // Verifica se o opcode está correto
        assertEquals(0xC4, inst.getOpcode(), "Opcode deve ser 0xC4");
        // Instruções de formato 1 não possuem operandos nem EA
        assertEquals(0, inst.getOperands().length, "Operands devem estar vazios");
        assertEquals(0, inst.getEffectiveAddress(), "EA deve ser 0 para formato 1");
    }
    ...
    public void testFormat2() {
        ...
        assertEquals(2, inst.getFormat(), "Formato deve ser 2");
        // Para formato 2, opcode é o primeiro byte
        assertEquals(0x04, inst.getOpcode(), "Opcode deve ser 0x04");
    ...
    public void testFormat3() {
        ...
        assertEquals(3, inst.getFormat(), "Formato deve ser 3");
        // Opcode = firstByte & 0xFC => 0x1F & 0xFC = 0x1C
        assertEquals(0x1C, inst.getOpcode(), "Opcode deve ser 0x1C");

        // EA: p=1, disp = 0x10 (16), tamanho da instrução = 3 bytes -> EA = 0 + 3 + 16 = 19
        assertEquals(19, inst.getEffectiveAddress(), "EA deve ser 19");
        ...
        assertFalse(inst.isIndexed(), "Indexed deve ser false");
    }
    ...
    public void testFormat4() {
        ...
        assertEquals(4, inst.getFormat(), "Formato deve ser 4");
        // Opcode = firstByte & 0xFC => 0x1F & 0xFC = 0x1C
        assertEquals(0x1C, inst.getOpcode(), "Opcode deve ser 0x1C");
        ...
        assertEquals(66055, inst.getEffectiveAddress(), "EA deve ser 66055");
